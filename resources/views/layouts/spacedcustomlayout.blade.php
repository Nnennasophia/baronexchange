...
<!-- Mirrored from {{$compd? $compd->companyname: 'Coming soon'}}.ltd/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Aug 2022 16:07:28 GMT -->
...
<header class="header">
                          ...
                          <div class="col-md-3 col-sm-6">
                              <div class="footer-nav-wrap text-white">
                                  ...
                                  <ul class="nav flex-column">
                                      ...
                                      <li class="nav-item">
                                          <a class="nav-link" href="{{route('about')}}">Knowledge Base</a>
                                      </li>
                                      <li class="nav-item">
                                          <a class="nav-link" href="{{route('faq')}}">FAQs</a>
                                      </li>
  ...
  <!-- Mirrored from {{$compd? $compd->companyname: 'Coming soon'}}.ltd/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Aug 2022 16:07:30 GMT -->
  </html>