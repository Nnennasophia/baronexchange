...
<!-- Mirrored from {{$compd? $compd->companyname: 'Coming soon'}}.ltd/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Aug 2022 16:07:28 GMT -->
...
<head>
   ...
   <meta name="theme-color" content="#000000">
    ...
    <link rel="stylesheet" href="{{asset("cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css")}}">
...
<header class="header">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="{{route('index')}}">
                <img src="{{asset("img/logo.png")}}" style="height: 30px;" alt="logo" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu">
                    ...
                    <li><a href="{{route('invest')}}">Investment Plans</a></li>
    ...
    <video src="{{asset("videos/obvideo.mp4")}}" muted loop autoplay></video>
    <div class="overlay"></div>
    <div class="video-text">
      <h1 style="text-align:center">{{$compd? $compd->companyname: 'Coming soon'}} </h1>
      <h1> BONDS, CRYPTO, FOREX, STOCKS ETC</h1>
      <p>Explore the all new auto trading future with ease...</p>
      <a href="{{route('register')}}" style="border:1px solid orange;padding:0.6rem;border-radius:12px;font-size:0.8rem;width:100px;display:inline-block;margin-top:-2rem">JOIN US</a>
    </div>
...
<section class="hero-equal-height pt-0 pb-0">
<div class="main">
<div class="wrapper">
<section class="bitcoin-logo-log" style="background-color:transparent">
...
<div style="text-align:left;text-indent:1rem">
                    ...
                    <div class="item">
                        <div class="col-md-8 col-lg-7 col-12">
                            <div class="hero-content-wrap text-white">
                               <!-- <span class="text-uppercase"><span >05:03pm</span> <b style="color: #f49917;" >Aug 09, 2022</b></span> -->
                                <h1 class="text-white">{{$compd? $compd->companyname: 'Coming soon'}} <span class="text-primary">for a digital-driven world.</span></h1>
                                <p class="lead">The investment climate is changing, and investors need to create ﬁnancial legacies that will stand the test of time. As the largest digital currency asset manager, {{$compd? $compd->companyname: 'Coming soon'}} helps investors access the ever-evolving digital economy to build their future in the present.</p>
...
<div class="position-relative py-2">
                <div class="container">
                    <div class="row flex-column-reverse flex-lg-row align-items-center text-center">
                        <div class="col-12 col-md-10 col-lg-6 text-lg-left">
                            <p class="opacity--80">Modern day agriculture won't be realistic without some of the most expensive machineries put in place for it. Agriculture is the future of industrial raw material and the world food supply. {{$compd? $compd->companyname: 'Coming soon'}} being a diversified and forward thinking investment company, has ventured into this sector of investment... Today, {{$compd? $compd->companyname: 'Coming soon'}} channels it's resources into it's various farms spread across the globe in order to generate daily profit for it's investors and secure the future of global food supply</p>
                            <!-- end of content col -->
                        </div>
                        <div class="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10 pos-abs-lg-vertical-center pos-right text-lg-left">
                            <picture><img src="{{asset("img/serv/agric.jpg")}}" alt="hero-image" class="img-fluid reveal"></picture>
                        </div>
                        <!-- enf of image col -->
                    </div>
            ...
            <div class="position-relative py-2">
                <div class="container">
                    <div class="row flex-column-reverse flex-lg-row align-items-center text-center">
                        <div class="col-12 col-md-10 col-lg-6 text-lg-left">
                            <p class="opacity--80">Forex trading covers about 5trillion dollars daily by just the act of trading foreign currencies and precious assets. It comes with a lot of strategies . {{$compd? $compd->companyname: 'Coming soon'}} has successfully secured 0.04% of the daily forex revenue by effective use of Technical and fundamental Analysis, Fibonacci etC. This serves as a high way of generating a lot of revenue for investors.</p>
                            <!-- end of content col -->
                        </div>
                        <div class="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10 pos-abs-lg-vertical-center pos-right text-lg-left">
                            <picture><img src="{{asset("img/serv/forex.jpg")}}" alt="hero-image" class="img-fluid reveal"></picture>
                        </div>
                        <!-- enf of image col -->
                    </div>
                    <!-- end of content block 2 row -->
             ...
             <div class="position-relative py-2">
                <div class="container">
                    <div class="row flex-column-reverse flex-lg-row align-items-center text-center">
                        <div class="col-12 col-md-10 col-lg-6 text-lg-left">
                            <p class="opacity--80">{{$compd? $compd->companyname: 'Coming soon'}} mega car investment program is a global program that gives our user a save up investment to be able to claim a car from {{$compd? $compd->companyname: 'Coming soon'}}. If a user's investment reaches our car investment program fund offer, Our logistics depertment will ship a car to the user's address.</p>
                            <!-- end of content col -->
                        </div>
                        <div class="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10 pos-abs-lg-vertical-center pos-right text-lg-left">
                            <picture><img src="{{asset("img/serv/car.png")}}" alt="hero-image" class="img-fluid reveal"></picture>
                        </div>
                        <!-- enf of image col -->
                    </div>
                    <!-- end of content block 2 row -->
            ...
            <div class="position-relative py-2">
                <div class="container">
                    <div class="row flex-column-reverse flex-lg-row align-items-center text-center">
                        <div class="col-12 col-md-10 col-lg-6 text-lg-left">
                            <p class="opacity--80">Bitcoin mining is the process of creating new bitcoin by solving a computational puzzle. Bitcoin mining is necessary to maintain the ledger of transaction upon which bitcoin is based. Miners have become very sophisticated over the last few years... {{$compd? $compd->companyname: 'Coming soon'}} have through the years been part of the bitcoin mining sector. {{$compd? $compd->companyname: 'Coming soon'}} having a pool of professional crypto miners uses complex machinery to speed up mining process</p>
                            <!-- end of content col -->
                        </div>
                        <div class="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10 pos-abs-lg-vertical-center pos-right text-lg-left">
                            <picture><img src="{{asset("img/serv/mining.jpg")}}" alt="hero-image" class="img-fluid reveal"></picture>
                        </div>
                        <!-- enf of image col -->
                    </div>
                    <!-- end of content block 2 row -->
            ...
            <div class="position-relative py-2">
                <div class="container">
                    <div class="row flex-column-reverse flex-lg-row align-items-center text-center">
                        <div class="col-12 col-md-10 col-lg-6 text-lg-left">
                            <p class="opacity--80">Real estate is a $217 trillion-dollar market making up almost 60% of all global wealth. It's the largest source of wealth, yet it is illiquid for 99% of the world today. In the past, you only had access to real estate if you were rich or had rich friends–meaning that most people weren't able to benefit from the passive income and capital appreciation it provides.. Today, {{$compd? $compd->companyname: 'Coming soon'}} cut out the expensive middle man and provide access for investors, by investing in shares of real estate using crypto currencies.</p>
                            <!-- end of content col -->
                        </div>
                        <div class="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10 pos-abs-lg-vertical-center pos-right text-lg-left">
                            <picture><img src="{{asset("img/serv/estate.jpg")}}" alt="hero-image" class="img-fluid reveal"></picture>
                        </div>
                        <!-- enf of image col -->
                    </div>
                    <!-- end of content block 2 row -->
...
<!-- TradingView Widget END -->
    ...
    </section><!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div class="tradingview-widget-container__widget"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testimonial-single shadow-sm gray-light-bg rounded p-4">
                        <blockquote>
                            After trading and mining I was able to withdraw my profits without any issues                        </blockquote>
                        <div class="client-img d-flex align-items-center justify-content-between pt-4">
                            <div class="d-flex align-items-center">
                                <img src="{{asset("img/pro.jpg")}}" alt="client" width="50" class="img-fluid rounded-circle shadow-sm mr-3"/>
                                <div class="client-info">
                                    <h5 class="mb-0">Niel elamir</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="testimonial-single shadow-sm gray-light-bg rounded p-4">
                        <blockquote>
                            Greenstonefunds is one of the best performing fund management company                        </blockquote>
                        <div class="client-img d-flex align-items-center justify-content-between pt-4">
                            <div class="d-flex align-items-center">
                                <img src="{{asset("img/pro.jpg")}}" alt="client" width="50" class="img-fluid rounded-circle shadow-sm mr-3"/>
                                <div class="client-info">
                                    <h5 class="mb-0">Christopher Wagner</h5>
                                    <small class="mb-0">Investor</small>
                                </div>
                            </div>
...
<section class="our-blog-section ptb-100">
  ...
  <div
    ...
    <h6 class="text-white text-center"><span class="ti-bag mr-2 color-secondary"></span>Recent Deposits</h6>
  ...
  <div class="px-4">
    ...
    <div class="">
      ...
      <table class="table table-hover mb-0 table-striped">
        <tbody>
                      <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Aboudar91mobarik</td>
            <td><b>USD 300.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Fizocoin1</td>
            <td><b>USD 10,000.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Lifestylewithdevon</td>
            <td><b>USD 300.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Ioanbule</td>
            <td><b>USD 20,800.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> CryptoCapital</td>
            <td><b>USD 50,000.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> dorinamihai</td>
            <td><b>USD 17,479.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Chryaclus </td>
            <td><b>USD 300.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Gent966</td>
            <td><b>USD 1,000.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Songod</td>
            <td><b>USD 300.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Nitronori74</td>
            <td><b>USD 725.00</b></td>
          </tr>
                  </tbody>
        <!--Table body-->
      </table>
  ...
  <div class="px-4">
    ...
    <div class="">
      ...
      <table class="table table-hover mb-0 table-striped">
        <tbody>
                      <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> davidtillyer</td>
            <td><b>USD 100.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> dorinamihai</td>
            <td><b>USD 100.00</b></td>
                    ...
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> TONTHAT79</td>
            <td><b>USD 42.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Hugo</td>
            <td><b>USD 26.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> alisonstellamcgill</td>
            <td><b>USD 100.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Beekay420</td>
            <td><b>USD 100.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Fab99</td>
            <td><b>USD 45.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Will202000</td>
            <td><b>USD 100.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> castojuan</td>
            <td><b>USD 200.00</b></td>
          </tr>
                    <tr>
            <td class="color-secondary"><span class="ti-check-box mr-2 color-secondary"></span> Digit543377899</td>
            <td><b>USD 20,000.00</b></td>
          </tr>
                  </tbody>
        <!--Table body-->
      </table>
                    ...
                    <div class="row footer-top-wrap">
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('invest')}}">Investment Plans</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('buybtc')}}">Where to Buy Bitcoin</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('legal')}}">Legal Information</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('policy')}}">Privacy Policy</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('contact')}}">Report Abuse</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('contact')}}">Knowledge Base</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('faq')}}">FAQs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('index')}}">System Status</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="footer-nav-wrap text-white">
                                ...
                                <ul class="get-in-touch-list">
                                    <li class="d-flex align-items-center py-2"><span class="fas fa-map-marker-alt mr-2"></span> {{$compd? $compd->companylocation: 'Coming soon'}}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-5">
                    <p class="copyright-text pb-0 mb-0">Copyrights © 2022. All
                        rights reserved
                        <a href="{{route('index')}}" target="_blank">{{$compd? $compd->companyname: 'Coming soon'}}</a></p>
                </div>
            </div>
        </div>
    </div>
...
_smartsupp.key = 'fec30b2bc1e360c20762f79d828ecb8b21d8b6d0';
